...
cat.each{|y| 
    SimTransaction.create!(category: y, amount: (100*(x+1)), sim_id: 1)
    x += 1
}
...
categ.each{|y| 
    CardTransaction.create!(category: y, amount: (100*(x+1)), card_id: 1)
    x += 1
}
...
SaveSim.create!(goalName: "Shoes", amount: 500, saving_id: 1, sim_id: 1)
SaveCard.create!(goalName: "Shoes", amount: 500, saving_id: 1, card_id: 1)
